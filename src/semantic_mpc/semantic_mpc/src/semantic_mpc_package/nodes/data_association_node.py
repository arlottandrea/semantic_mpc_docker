...
def load_params():
    return {
        ...
        "minimum_detection_score": float(rospy.get_param("~minimum_detection_score", 0.62)),
        "minimum_tree_detections": int(rospy.get_param("~minimum_tree_detections", 6)),
        "evidence_count_midpoint": float(rospy.get_param("~evidence_count_midpoint", 4.75)),
        "evidence_count_steepness": float(rospy.get_param("~evidence_count_steepness", 2.05)),
