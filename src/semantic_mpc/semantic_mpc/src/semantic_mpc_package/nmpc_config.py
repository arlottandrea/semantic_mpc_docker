...
def load_semantic_mpc_params():
    names = [
        ...
        "rrt_max_nodes",
        "rrt_target_count",
        "waypoint_attraction_weight",
        "waypoint_replan_distance",
        "waypoint_uncertainty_gain",
        "waypoint_min_weight_scale",
        "active_target_count",
