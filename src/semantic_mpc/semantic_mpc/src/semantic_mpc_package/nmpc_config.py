...
def default_nmpc_params():
    return {
        ...
        "hidden_layers": 2,
        "nn_input_dim": 3,
        "nn_conditioned_input_dim": 4,
        "nn_output_dim": 4,
        "nn_model_type": "class_conditioned",
        "nn_yaw_harmonics": 2,
        ...
        "nn_gate_slope": 10.0,
        "model_device": "cuda",
        "nn_model_dir": "/models/nmpc/fog/class_conditioned/5m",
        "nn_model_path": "",
        "nn_checkpoint_output_labels": ["observed_raw", "observed_ripe"],
        "nn_output_labels": [
